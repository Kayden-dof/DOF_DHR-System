      ...
      <section className="relative flex flex-col items-center bg-canvas px-5 py-9">
        ...
        <div className="flex w-full max-w-[25rem] flex-1 flex-col justify-center">
          {/*
            ...
            */}
          {/*
            * 좁은 화면에서는 여기가 브랜드 자리다. 왼쪽 면이 접혀 로고가 여기
            * 하나뿐이므로 작게 두면 회사가 보이지 않는다.
            *
            * 여기서도 높이가 아니라 폭으로 잡는다 - 로고마다 가로세로 비가
            * 다르다. 입력 칸 너비(25rem)의 절반쯤이 눈에 맞는다.
            */}
          <div className="mb-8 flex justify-center lg:hidden">
            {/*
              * 올라온 PNG 는 둘레에 투명 여백을 두른다. 상자 폭의 절반쯤만
              * 실제 그림이라, 눈에 맞추려면 상자를 그만큼 크게 잡아야 한다.
              */}
            <BrandMark className="w-[min(15rem,72%)] text-[1.75rem]" />
          </div>
